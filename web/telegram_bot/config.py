...
WEBHOOK_SSL_CERT = '/var/www/web/telegram_bot/webhook_cert.pem'  # Path to the ssl certificate
WEBHOOK_SSL_PRIV = '/var/www/web/telegram_bot/webhook_pkey.pem'  # Path to the ssl private key
