...
WEBHOOK_SSL_CERT = '/var/www/web/telegram_bot/certificate.crt'  # Path to the ssl certificate
WEBHOOK_SSL_PRIV = '/var/www/web/telegram_bot/private.key'  # Path to the ssl private key
